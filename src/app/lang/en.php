<?php
	...
	$language_data['--account-not-active--'] = 'Account is not active! We cannot log you in. If you recently registered or asked for new password then please check your mailbox for an e-mail with activation link. Otherwise ask for new password.';
